...
public class Test_ch10_LottoWinningProcess {
	...
	static int salesLotto() {
		...
		int count=1000000+number.nextInt(10000000);
		DecimalFormat dc = new DecimalFormat("###,###,###,###");
		String salesMoney = dc.format(count*1000);
		String salesMoney2 = dc.format(count*50);
		System.out.println("총 판매금액 : " + salesMoney + " 원");
		System.out.println("총 상금 : " + salesMoney2 + " 원");
		System.out.println("1등 당첨 금액 : " + salesMoney + " 원");
		System.out.println("2등 당첨 금액 : " + salesMoney + " 원");
		System.out.println("3등 당첨 금액 : " + salesMoney + " 원");
		System.out.println("4등 당첨 금액 : 50,000 원");
		System.out.println("5등 당첨 금액 : 5,000 원");
		return count;
	}
